...
/// <summary>
/// EF Core implementation of Unit of Work for PointsEngine.
/// Manages database transactions for atomic operations.
/// </summary>
public class PointsEngineUnitOfWork : IUnitOfWork
{
    private readonly PointsEngineDbContext _context;
    private IDbContextTransaction? _transaction;

    public PointsEngineUnitOfWork(PointsEngineDbContext context)
    {
        _context = context;
    }
